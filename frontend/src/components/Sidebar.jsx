...
import {
  ...
  GraduationCap, ListChecks, Table2, Settings, ChevronRight
} from "lucide-react";
import { cn } from "@/lib/utils";

export const Sidebar = ({ sessionName }) => {
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-3 py-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-white truncate">Department</p>
            <p className="text-xs text-slate-400 truncate">CSE · Anna University</p>
          </div>
        </div>
      </div>
    </aside>
